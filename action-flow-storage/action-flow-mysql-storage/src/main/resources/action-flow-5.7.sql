DROP TABLE IF EXISTS `action-flow`.`af_action`;
DROP TABLE IF EXISTS `action-flow`.`af_action_param`;
DROP TABLE IF EXISTS `action-flow`.`af_action_param_ex`;
DROP TABLE IF EXISTS `action-flow`.`af_api`;
DROP TABLE IF EXISTS `action-flow`.`af_api_param`;
DROP TABLE IF EXISTS `action-flow`.`af_api_param_ex`;
DROP TABLE IF EXISTS `action-flow`.`af_extract`;
DROP TABLE IF EXISTS `action-flow`.`af_flow`;
DROP TABLE IF EXISTS `action-flow`.`af_format`;
DROP TABLE IF EXISTS `action-flow`.`af_param`;
DROP TABLE IF EXISTS `action-flow`.`af_result`;
DROP TABLE IF EXISTS `action-flow`.`af_watcher`;
DROP TABLE IF EXISTS `action-flow`.`af_watcher_rs`;
DROP TABLE IF EXISTS `action-flow`.`af_work`;
DROP TABLE IF EXISTS `action-flow`.`table_1`;
DROP TABLE IF EXISTS `action-flow`.`watcher`;

CREATE TABLE `action-flow`.`af_action`  (
...
CREATE TABLE `action-flow`.`af_action_param`  (
  `id` varchar(255) NOT NULL,
...
CREATE TABLE `action-flow`.`af_action_param_ex`  (
  `id` varchar(255) NOT NULL,
...
CREATE TABLE `action-flow`.`af_api`  (
  `id` varchar(255) NOT NULL,
...
CREATE TABLE `action-flow`.`af_api_param`  (
  `id` int NOT NULL,
...
CREATE TABLE `action-flow`.`af_api_param_ex`  (
  `id` varchar(255) NOT NULL,
...
CREATE TABLE `action-flow`.`af_extract`  (
  `id` varchar(255) NOT NULL,
...
CREATE TABLE `action-flow`.`af_flow`  (
  `id` varchar(255) NOT NULL,
...
CREATE TABLE `action-flow`.`af_format`  (
  `id` varchar(255) NOT NULL,
  `class_str` varchar(255) NOT NULL COMMENT '转换器类全路径',
  PRIMARY KEY (`id`)
);

CREATE TABLE `action-flow`.`af_param`  (
  `id` varchar(255) NOT NULL,
...
CREATE TABLE `action-flow`.`af_result`  (
  `id` varchar(255) NOT NULL,
...
CREATE TABLE `action-flow`.`af_watcher`  (
  `id` varchar(255) NOT NULL,
...
CREATE TABLE `action-flow`.`af_watcher_rs`  (
  `id` varchar(255) NOT NULL,
...
CREATE TABLE `action-flow`.`af_work`  (
  `id` varchar(255) NOT NULL,
